            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-8 col-lg-9 col-md-11 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('collection.donate', $collection->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <p>{{$collection->organization->organization_name}}</p>
                                </div>
                            
                                <div class="mb-3">
                                    <label for="description" class="form-label">Rut</label>
                                    <p>{{$collection->organization->organization_rut}}-{{$collection->organization->organization_cv}}</p>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="image" class="form-label">Comprobante</label>
                                    <input type="file" class="form-control" id="file" name="file" accept="image/*">
                                    <p>*Adjunte una imagen clara y visible.</p>
                                </div>
