            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-8 col-lg-9 col-md-11 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                    <h5>Datos Adoptante</h5>
                    <form method="POST" action="{{ route('adopter.store') }}" enctype="multipart/form-data">
                        @csrf
                    
                        <!-- Campo para Experiencia -->
                        <div class="form-group">
                            <label for="experience">¿Tiene experiencia previa con mascotas?</label>
                        ...
                        <!-- Campo para Tipo de Casa -->
                        <div class="form-group">
                            <label for="type_of_house">Tipo de vivienda</label>
                            <select class="form-control" id="type_of_house" name="type_of_house">
                                <option value="1">Casa con patio</option>
                                <option value="0">Apartamento</option>
                            </select>
                        </div>
                    
                        <!-- Campo para Otras Mascotas -->
                        <div class="form-group">
                            <label for="other_pet">¿Tiene otras mascotas?</label>
                            <select class="form-control" id="other_pet" name="other_pet">
                                <option value="1">Sí</option>
                                <option value="0">No</option>
                            </select>
                        </div>
                        ...
                        <!-- Campo para Cantidad -->
                        <div class="form-group">
                            <label for="quantity">Número de mascotas</label>
                            <input type="number" class="form-control" id="quantity" name="quantity" required>
                        </div>
                    
                        <!-- Campo para Imagen de Perfil del Adoptante -->
                        <div class="form-group">
                            <label for="adopter_profile_image">Imagen de Perfil</label>
                            <input type="file" class="form-control" id="adopter_profile_image" name="adopter_profile_image">
                        </div>
                    
                        <!-- Campo para Imagen de Portada del Adoptante -->
                        <div class="form-group">
                            <label for="adopter_cover_image">Imagen de Portada</label>
                            <input type="file" class="form-control" id="adopter_cover_image" name="adopter_cover_image">
                        </div>
