                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('visit.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="title" class="form-label">Titulo de la Visita</label>
                                    <input type="text" class="form-control" id="title" name="title" required>
                                </div>
                            
                                <div class="mb-3">
                                    <label for="description" class="form-label">Tipo de Visita</label>
                                    <select  class="form-control" name="meeting_type" id="meeting_type">
                                        <option value="Presencial - Sede">Presencial - Sede</option>
                                        <option value="Presencial - Domicilio">Presencial - Domicilio</option>
