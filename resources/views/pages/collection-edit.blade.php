                    ...
                    <div class="card-body">
                        <form action="{{ route('collection.update', $collection->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" required>{{ $collection->description }}</textarea>
                            </div>
                        
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email" name="email" value="{{ $collection->email }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="bank" class="form-label">Banco</label>
                                <input type="text" class="form-control" id="bank" name="bank" value="{{ $collection->bank }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="type_of_account" class="form-label">Tipo de Cuenta</label>
                                <input type="text" class="form-control" id="type_of_account" name="type_of_account" value="{{ $collection->type_of_account }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="account_number" class="form-label">Número de Cuenta</label>
                                <input type="text" class="form-control" id="account_number" name="account_number" value="{{ $collection->account_number }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="amount" class="form-label">Cantidad</label>
                                <input type="text" class="form-control" id="amount" name="amount" value="{{ $collection->amount }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="start_date" class="form-label">Fecha de Inicio</label>
                                <input type="date" class="form-control" id="start_date" name="start_date" value="{{ $collection->start_date }}" required>
                            </div>
                        
                            <div class="mb-3">
                                <label for="finish_date" class="form-label">Fecha de Fin</label>
                                <input type="date" class="form-control" id="finish_date" name="finish_date" value="{{ $collection->finish_date }}" required>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Actualizar Colecta</button>
                        </form>
                        </div>
                    </div>
                </div>
