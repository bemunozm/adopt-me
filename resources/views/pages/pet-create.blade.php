                            ...
                            <form action="{{ route('pet.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="age" name="age" placeholder="11 meses" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Nivel de Energia</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Sociable con Perros</label>
                                    <select class="form-control" id="social_dog" name="social_dog">
                                        <option value="No se sabe">No se sabe</option>
                                        <option value="No los considera">No los considera</option>
                                        <option value="No">No</option>
                                        <option value="Si">Si</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Sociable con Gatos</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Sociable con Ninos</label>
                                ...
                                <div class="mb-3">
                                    <label for="site_id" class="form-label">Sede</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="images" name="images[]" multiple onchange="handleFileSelect(event)">

                                </div>
                                <input type="hidden" name="status" value="Sin Adoptar">
