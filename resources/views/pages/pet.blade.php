...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Mascotas'])
                ...
                <div class="card-header pb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <form action="{{ route('pet.filter') }}" method="GET">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @if ($pets->isEmpty())
                                <tr><td>
                                    <span class="text-lg">Aun no hay mascotas en adopcion :c</span>
                                </td></tr>
                                @else
                                @foreach ($pets as $pet)
                                    <tr>
                                        ...
                                        <td class="text-center px-3">
                                            <div class="">
                                                ...
                                                <ul class="dropdown-menu px-2 py-3" aria-labelledby="dropdownMenuButton">
                                                  <li><a class="dropdown-item border-radius-md" href="{{ route('pet.show', $pet->id) }}">Ver Mas</a></li>
                                                  @if ($user->type == 'Organizacion')
