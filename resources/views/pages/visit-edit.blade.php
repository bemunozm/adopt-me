                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('visit.update', $visit->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                {{-- Nombre de la Vacuna --}}
                                <div class="mb-3">
                                    <label for="title" class="form-label">Titulo de la Vacuna</label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $visit->title }}" required>
                                </div>
                            
                                {{-- Descripción --}}
                                <div class="mb-3">
                                    <label for="description" class="form-label">Descripción</label>
                                    <textarea class="form-control" id="description" name="description" rows="4" required>{{ $visit->notes }}</textarea>
                                </div>
                            
                                {{-- Fecha --}}
                                <div class="mb-3">
                                    <label for="date" class="form-label">Fecha</label>
                                    <input type="date" class="form-control" id="date" name="date" value="{{ $visit->meeting_date }}" required>
                                </div>
                            
                                {{-- Nombre del Veterinario --}}
                                <div class="mb-3">
                                    <label for="vet" class="form-label">Nombre del Veterinario</label>
                                    <input type="text" class="form-control" id="vet" name="vet" value="{{ $visit->meeting_type }}" required>
                                </div>
