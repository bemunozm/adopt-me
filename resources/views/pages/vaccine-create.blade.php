                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('vaccine.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="bank" class="form-label">Nombre del Veterinario</label>
                                    <input type="text" class="form-control" id="vet" name="vet" required>
                                </div>
                            

                                <div class="mb-3">
                                    <label for="image" class="form-label">Certificado de Vacunacion</label>
                                ...
                                <button type="submit" class="btn btn-primary">Subir Vacuna</button>
                            </form>
